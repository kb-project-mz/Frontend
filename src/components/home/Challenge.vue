...
<template>
  <div class="h-full border border-gray-200 rounded-lg p-12 bg-gray-50 w-1/2 mx-auto">
    ...
    <RouterLink to="/challenge" class="text-right block text-sm underline text-gray-500">
      챌린지 보러 가기
    </RouterLink>
  </div>
</template>
