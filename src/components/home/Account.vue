...
<template>
  <div class="border border-gray-200 rounded-lg p-6 bg-yellow-300 w-1/2 lg:w-1/3 mx-auto">
    <div v-if="balanceByMember.length === 0" class="py-10 flex justify-center text-lg underline">
