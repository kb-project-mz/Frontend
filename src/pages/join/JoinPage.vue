      ...
      <form @submit.prevent="join">
        ...
        <div class="mb-6">
          <div class="flex items-center">
            <input v-model="member.birthday" type="text"
              ...
              id="birthday" placeholder="생년월일 6자리" maxlength="6" required />
            <span class="px-2">-</span>
            <input v-model="member.gender" type="text"
              ...
              id="gender" maxlength="1" @input="handleBirthdayInput" required />
            <span class="px-2">●●●●●●</span>
          </div>
        </div>
